...
CREATE TABLE address (
  ...
  -- Coluna GEOMETRY removida por incompatibilidade com versão 5.1
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Corrigido para @@storage_engine (padrão MySQL 5.1)
...
CREATE TABLE staff (
  ...
  password VARCHAR(40) COLLATE utf8_general_ci DEFAULT NULL,
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
